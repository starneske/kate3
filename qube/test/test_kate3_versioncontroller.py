...
HELLO_VERSION = "/v1/kate3/version"
...
class Testkate3VersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_kate3_default_version(self, *args, **kwargs):
    ...
    def test_kate3_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
