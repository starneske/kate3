...
from qube.src.api.kate3controller import kate3Controller
from qube.src.api.kate3controller import kate3ItemController
from qube.src.api.versioncontroller import kate3ItemVersionController
...
api.add_resource(kate3ItemVersionController, '/v1/kate3/version')
api.add_resource(kate3Controller, '/v1/kate3')
api.add_resource(kate3ItemController, '/v1/kate3/<string:entity_id>')
